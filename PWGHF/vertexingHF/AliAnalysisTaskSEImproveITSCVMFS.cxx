...
AliAnalysisTaskSEImproveITSCVMFS::AliAnalysisTaskSEImproveITSCVMFS() 
  :AliAnalysisTaskSE(),
   fD0ZResPCur  (0),
   fD0ZResKCur  (0),
   fD0ZResPiCur (0),
...
AliAnalysisTaskSEImproveITSCVMFS::AliAnalysisTaskSEImproveITSCVMFS(const char *name,
                           const char *period,
...
void AliAnalysisTaskSEImproveITSCVMFS::UserCreateOutputObjects() {
  //
...
void AliAnalysisTaskSEImproveITSCVMFS::UserExec(Option_t*) {
  //
  // The event loop
  //
  AliAODEvent *ev=0x0;
...
void AliAnalysisTaskSEImproveITSCVMFS::SmearTrack(AliVTrack *track,Double_t bz) {
...
AliESDVertex* AliAnalysisTaskSEImproveITSCVMFS::RecalculateVertex(const AliVVertex *old,TObjArray *tracks,Double_t bField) {
  //
...
Double_t AliAnalysisTaskSEImproveITSCVMFS::EvalGraph(Double_t x,const TGraph *graph,const TGraph *graphSA) const {
  //
...
Int_t AliAnalysisTaskSEImproveITSCVMFS::PhiBin(Double_t phi) const { 
...
ClassImp(AliAnalysisTaskSEImproveITSCVMFS);
